...
export default function PrimaryLink({
  ...
  if (size === 'large') {
    newClassName += ' text-[15px] lg:text-[18px] font-medium font-outfit py-3 px-5';
  } else if (size === 'small') {
    newClassName += ' text-[12px] lg:text-[14px] font-light font-outfit py-2 px-4';
  } else {
    newClassName += ' text-[14px] lg:text-[16px] font-regular font-outfit py-2.5 px-5';
  }
