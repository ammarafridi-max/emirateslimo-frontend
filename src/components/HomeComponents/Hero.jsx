...
export default function Hero({
  ...
  text = 'Experience refined travel with Emirates Limo — premium vehicles, professional chauffeurs, and seamless airport transfers across the UAE.',
}) {
  return (
      ...
      <Container className="relative z-10">
        ...
        >
          <div className="text-white">
            <p className="uppercase tracking-[3px] text-accent-400 text-sm mb-3 font-light">{subtitle}</p>
            <PageHeading className="text-[32px] lg:text-[48px] leading-[1.2] font-light mb-3">{title}</PageHeading>
            <p className="text-[17px] lg:text-[19px] font-[200] text-white/60 max-w-xl leading-7 mt-3">{text}</p>
          </div>
          <LimoForm />
        </motion.div>
      </Container>
